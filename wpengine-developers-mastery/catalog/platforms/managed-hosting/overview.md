# Managed Hosting Platform — Overview
...
- Account/site onboarding and environment topology.
- Domains, DNS, SSL, and traffic routing.
- Backups, restore flows, and deployment safety.
- Performance, security, and operational controls.
